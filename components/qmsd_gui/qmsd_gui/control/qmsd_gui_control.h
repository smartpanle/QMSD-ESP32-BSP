...
//action list of set_style

#define QMSD_GUI_ACTION_SET_BG_COLOR            "bg_color"
#define QMSD_GUI_ACTION_SET_BG_OPA              "bg_opa"
#define QMSD_GUI_ACTION_SET_BG_GRAD_COLOR       "bg_grad_color"
#define QMSD_GUI_ACTION_SET_BG_GRAD_DIR         "bg_grad_dir"
...
#define QMSD_GUI_ACTION_SET_LINE_POINT          "line_point"
...
#define QMSD_GUI_ACTION_SET_TEXT_LETTER_SPACE   "text_letter_space"
#define QMSD_GUI_ACTION_SET_TEXT_LINE_SPACE     "text_line_space"
...
#define QMSD_GUI_ACTION_SET_BORDER              "border_side" 
...
#define QMSD_GUI_ACTION_SET_RADIUS              "radius"
...
/**
 * @brief input json string with "{"wid":"id","cmd":"cmd","attr":{"action":"act","arg1":"",...}}"
 * 
 * @param json_str 
 * @param mode 
 * @return qmsd_err_t 
...
qmsd_err_t qmsd_ctrl_roller_def_cb(qmsd_gui_widget_t* widget,void* user_data);
...
void qmsd_gui_uart_debug_start(int16_t tx,int16_t rx);
