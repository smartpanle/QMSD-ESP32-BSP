...
#define QMSD_SCREEN_WIDTH 800
#define QMSD_SCREEN_HIGHT 480

#define QMSD_SCREEN_BK_FREQ     22222

#define QMSD_RGB_CLK_FREQ           (24000000)
#define QMSD_RGB_HSYNC_PULSE_WIDTH  (1)
#define QMSD_RGB_HSYNC_BACK_PORCH   (87)
#define QMSD_RGB_HSYNC_FRONT_PORCH  (20)
#define QMSD_RGB_VSYNC_PULSE_WIDTH  (1)
#define QMSD_RGB_VSYNC_BACK_PORCH   (31)
#define QMSD_RGB_VSYNC_FRONT_PORCH  (5)
