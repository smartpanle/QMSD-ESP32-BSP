...
scr_driver_t lcd_rm68120_default_driver = {
    ...
    .init_reg = NULL,
    .write_cmd = lcd_rm68120_write_cmd,
    .write_data = lcd_rm68120_write_data,
};
...
esp_err_t lcd_rm68120_init(const scr_controller_config_t *lcd_conf)
{
    ...
    if (lcd_rm68120_default_driver.init_reg) {
        ret = lcd_rm68120_default_driver.init_reg();
    } else {
...
esp_err_t lcd_rm68120_write_cmd(uint16_t cmd) {
    return LCD_WRITE_CMD(cmd);
}

esp_err_t lcd_rm68120_write_data(uint16_t data) {
